...
<script type="text/javascript">
	...
	$(function() {
		...
		/* 데이터 저장용 */
		var rmplayerBullet= new Array();
		var remoteenemyBalls= new Array();
		var remoteitem= new Array();
		var remotelaser= new Array();
	...
	function remoteTwoplayer() {
		console.log("받는곳"+data.length);

				var Player2 = data[datacnt].rmPlayer;
var playerBullet2 = data[datacnt].rmplayerBullet;
		...
		function render() {
			...
			for (var i = 0; i < playerBullet.length; i++) {
				var rmplayerBulletchild= {
						x:playerBullet[i].x,
						y:playerBullet[i].y
				};
				rmplayerBullet.push(rmplayerBulletchild)
			}
			
			
			var data = {
						rmPlayer : rmPlayer,
					 	rmplayerBullet : rmplayerBullet,
			...
			if(spacecnt%30==0){
				...
				database = new Array();
			 	rmplayerBullet = new Array();
			 	remoteenemyBalls = new Array();
				remoteitem = new Array();
				remotelaser = new Array();
			}
			if(spacecnt%20==0){
				spacetimer=true;
			}
		...
		function playerExplosion() {
			var data = {explosion: explosion,playerBullet : playerBullet,enemyBalls:enemyBalls,item:item,laser:laser,gameend:true};
			var msg = {
					position : "game",
					cmd : "playing",
					nick : nick,
