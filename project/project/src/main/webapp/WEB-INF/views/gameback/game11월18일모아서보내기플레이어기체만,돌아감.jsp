...
<script type="text/javascript">
	...
	$(function() {
		...
		function remoteTwoplayer() {
			...
			console.log("받는곳"+datacnt);
			var Player2 = data[datacnt].remotePlayer;
		/* 	var enemyBalls2 = data[datacnt].remoteenemyBalls;
			var playerBullet2 = data[datacnt].remoteplayerBullet;
			var item2 = data[datacnt].remoteitem;
			 */
