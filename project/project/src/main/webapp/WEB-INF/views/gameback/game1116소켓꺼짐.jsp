...
<script type="text/javascript">
	...
	function remoteTwoplayer(data) {
		gameEnd2= data.gameend;
		if(gameEnd2){
			 explosion2 = data.explosion;
		}
		else{
			 Player2 = data.remotePlayer;
		}
		
		 playerBullet2 = data.playerBullet;
		 enemyBalls2 =  data.enemyBalls; 
		 item2  =  data.item; 
		 laser2 =  data.laser; 
		...
		function render() {
			/* render 돌릴때마다 메세지 전송 */
			var data = {remotePlayer : playerUnit,playerBullet : playerBullet,enemyBalls:enemyBalls,item:item,laser:laser,gameend:false};
			var msg = {
					position : "game",
					cmd : "playing",
					nick : nick,
