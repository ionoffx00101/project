										...
										<ul class="pagination pagination-lg">
											...
											<c:choose>
												<c:when test="${nvo.leftMore}">
													<li><a href="searchnav?page=${nvo.links[0]-1}"> « </a></li>
												</c:when>
											</c:choose>
											...
											<c:forEach var="s" items="${nvo.links}">
												<c:choose>
													<c:when test="${nvo.currPage == s}">
														<li class="active"><a href="searchnav?page=${s}">${s}</a></li>
													</c:when>
													<c:otherwise>
														<li><a href="searchnav?page=${s}">${s}</a></li>
													</c:otherwise>
												</c:choose>
											</c:forEach>
											<!--  -->
											<c:choose>
												...
												<c:when test="${nvo.rightMore}">
													<li><a href="searchnav?page=${nvo.links[1]+1}">»</a></li>
												</c:when>
											</c:choose>
										</ul>
									</div>
